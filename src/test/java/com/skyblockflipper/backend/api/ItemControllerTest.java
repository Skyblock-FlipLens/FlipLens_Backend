...
class ItemControllerTest {
    ...
    void listItemsDelegatesToService() {
        ...
        Pageable pageable = StandardPagination.pageable(0, 12, 12, Sort.by("id").ascending());
        ...
        Page<ItemDto> response = controller.listItems("WHEAT", null, null, null, null, 0, 12);
    ...
    void listNpcBuyableItemsDelegatesToService() {
        ...
        Pageable pageable = StandardPagination.pageable(0, 100, 100, Sort.by("itemId").ascending());
        ...
        Page<NpcShopOfferDto> response = controller.listNpcBuyableItems("WHEAT", 0, 100);
    ...
    void itemFlipsDelegatesToAnalyticsService() {
        ...
        Pageable pageable = StandardPagination.pageable(0, 10, 20, Sort.by("id").ascending());
        ...
        assertEquals(flips, controller.itemFlips("HYPERION", 0, 10));
